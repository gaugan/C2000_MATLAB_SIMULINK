###########################################################################
## Makefile generated for Simulink model 'ADC_Blinky_Test'. 
## 
## Makefile     : ADC_Blinky_Test.mk
## Generated on : Wed Feb 22 17:05:08 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ADC_Blinky_Test.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = ADC_Blinky_Test_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ADC_Blinky_Test.elf
...
INCLUDES_BUILDINFO = -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/include -I$(START_DIR)/ADC_Blinky_Test_ert_rtw -I$(START_DIR) -I$(START_DIR)/BBB -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/src -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/beaglebone/include -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_ = -DMODEL=ADC_Blinky_Test -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DON_TARGET_WAIT_FOR_START=1 -DONESTEPFCN=1 -DEXT_MODE=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=ADC_Blinky_Test -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/ADC_Blinky_Test_ert_rtw/ADC_Blinky_Test.c $(START_DIR)/ADC_Blinky_Test_ert_rtw/ADC_Blinky_Test_data.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/src/armcortexa_v4l2_capture.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/src/armcortexa_sdl_video_display.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/blocks/sfcn/src/armcortexa_v4l2_capture_linux.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/src/MW_analogInput.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/src/MW_led.c

MAIN_SRC = $(START_DIR)/ADC_Blinky_Test_ert_rtw/ert_main.c
...
OBJS = ADC_Blinky_Test.c.o ADC_Blinky_Test_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o armcortexa_v4l2_capture.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o armcortexa_sdl_video_display.c.o armcortexa_v4l2_capture_linux.c.o MW_analogInput.c.o MW_led.c.o
...
CPP_LDFLAGS_ = -march=armv7-a -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8 --sysroot="C:\ProgramData\MATLAB\SupportPackages\R2016b\toolbox\target\supportpackages\beaglebone\libc" -lSDL
...
CPP_SHAREDLIB_LDFLAGS_ = -march=armv7-a -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8 --sysroot="C:\ProgramData\MATLAB\SupportPackages\R2016b\toolbox\target\supportpackages\beaglebone\libc" -lSDL
...
LDFLAGS_ = -march=armv7-a -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8 --sysroot="C:\ProgramData\MATLAB\SupportPackages\R2016b\toolbox\target\supportpackages\beaglebone\libc" -lSDL
...
SHAREDLIB_LDFLAGS_ = -march=armv7-a -mfloat-abi=hard -mfpu=neon -mtune=cortex-a8 --sysroot="C:\ProgramData\MATLAB\SupportPackages\R2016b\toolbox\target\supportpackages\beaglebone\libc" -lSDL
...
%.c.o : $(START_DIR)/ADC_Blinky_Test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/ADC_Blinky_Test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/ADC_Blinky_Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_analogInput.c.o : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/src/MW_analogInput.c
	$(CC) $(CFLAGS) -o "$@" "$<"
