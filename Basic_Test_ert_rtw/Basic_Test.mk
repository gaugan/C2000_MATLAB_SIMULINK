###########################################################################
## Makefile generated for Simulink model 'Basic_Test'. 
## 
## Makefile     : Basic_Test.mk
## Generated on : Tue Feb 21 12:18:14 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Basic_Test.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Basic_Test_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Basic_Test.elf
...
DEFINES_ = -DMODEL=Basic_Test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DARM_PROJECT -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=Basic_Test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Basic_Test_ert_rtw/Basic_Test.c $(START_DIR)/Basic_Test_ert_rtw/Basic_Test_data.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/arm_cortex_a/src/MW_led.c

MAIN_SRC = $(START_DIR)/Basic_Test_ert_rtw/ert_main.c
...
OBJS = Basic_Test.c.o Basic_Test_data.c.o linuxinitialize.c.o MW_led.c.o
...
%.c.o : $(START_DIR)/Basic_Test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Basic_Test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.pp.o : $(START_DIR)/Basic_Test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
