###########################################################################
## Makefile generated for Simulink model 'Blinky_ADC_SCI'. 
## 
## Makefile     : Blinky_ADC_SCI.mk
## Generated on : Mon Feb 06 23:04:51 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Blinky_ADC_SCI.out
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
MODELREF_LINK_RSPFILE_NAME = Blinky_ADC_SCI_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Blinky_ADC_SCI.out
...
DEFINES_ = -DMODEL=Blinky_ADC_SCI -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DDAEMON_MODE=1 -DMW_PIL_SCIFIFOLEN=4 -DRT -DSTACK_SIZE=512
...
DEFINES_STANDARD = -DMODEL=Blinky_ADC_SCI -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
CPP_LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0 --define BOOT_FROM_FLASH=0 --define BOOT_USING_BL=0
...
%.obj : $(START_DIR)/Blinky_ADC_SCI_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Blinky_ADC_SCI_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Blinky_ADC_SCI_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Blinky_ADC_SCI_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
