...
void Blinky_ePWM_eCAP_initialize(void)
{
  ...
  /*** Initialize ePWM1 modules ***/
  {
    ...
    EPwm1Regs.TBPRD = 64800;           // Time Base Period Register
    ...
    EPwm1Regs.CMPA.half.CMPA = 32400;  // Counter Compare A Register
    EPwm1Regs.CMPB = 32400;            // Counter Compare B Register
