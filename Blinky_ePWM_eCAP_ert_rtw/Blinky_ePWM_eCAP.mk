###########################################################################
## Makefile generated for Simulink model 'Blinky_ePWM_eCAP'. 
## 
## Makefile     : Blinky_ePWM_eCAP.mk
## Generated on : Wed Feb 08 14:05:49 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Blinky_ePWM_eCAP.out
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
MODELREF_LINK_RSPFILE_NAME = Blinky_ePWM_eCAP_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Blinky_ePWM_eCAP.out
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Blinky_ePWM_eCAP_ert_rtw -I$(START_DIR) -I$(START_DIR)/LAUNCHXL-F28069M -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src -I$(MATLAB_ROOT)/toolbox/target/extensions/processor/tic2000/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c -IC:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/inc -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/include -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil
...
DEFINES_ = -DMODEL=Blinky_ePWM_eCAP -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DDAEMON_MODE=1 -DMW_PIL_SCIFIFOLEN=4 -DRT -DSTACK_SIZE=512
...
DEFINES_STANDARD = -DMODEL=Blinky_ePWM_eCAP -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/MW_c28xx_board.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/Blinky_ePWM_eCAP.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/Blinky_ePWM_eCAP_data.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/MW_c28xx_can.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/MW_c28xx_cap.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/MW_c28xx_csl.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/MW_c28xx_pwm.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/can_datatype_ground.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/rtGetInf.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/rtGetNaN.c $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/rt_nonfinite.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c2806xBoard_Realtime_Support.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_CpuTimers.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_DefaultIsr.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_headers/source/F2806x_GlobalVariableDefs.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_PieCtrl.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_PieVect.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_SysCtrl.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_usDelay.asm C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_CodeStartBranch.asm C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_Dma.c C:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/source/F2806x_Adc.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/blapp_support.c C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c2806xSchedulerTimer0.c

MAIN_SRC = $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/ert_main.c
...
LIBS = C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c28069.cmd C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/rtlib/IQmath_fpu32.lib $(MATLAB_ROOT)/toolbox/idelink/extensions/ticcs/c2000/c2806xPeripherals.cmd
...
%.obj : $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Blinky_ePWM_eCAP_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
c2806xBoard_Realtime_Support.obj : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c2806xBoard_Realtime_Support.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
blapp_support.obj : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/blapp_support.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


c2806xSchedulerTimer0.obj : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c2806xSchedulerTimer0.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
