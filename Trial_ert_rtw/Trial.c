...
#include "Trial.h"
#include "Trial_private.h"

/* Real-time model */
RT_MODEL_Trial_T Trial_M_;
RT_MODEL_Trial_T *const Trial_M = &Trial_M_;

/* Model step function */
void Trial_step(void)
{
  /* S-Function (c2802xpwm): '<Root>/High-Low Side Driver Signal' */

  /*-- Update CMPA value for ePWM2 --*/
  {
    EPwm2Regs.CMPA.bit.CMPA = (uint16_T)(Trial_P.Duty_Value);
  }
}

/* Model initialize function */
void Trial_initialize(void)
{
  /* Registration code */

  /* initialize error status */
  rtmSetErrorStatus(Trial_M, (NULL));
