###########################################################################
## Makefile generated for Simulink model 'ADC_LED_CAN'. 
## 
## Makefile     : ADC_LED_CAN.mk
## Generated on : Fri Sep 23 15:46:08 2016
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ADC_LED_CAN.out
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/admin/Documents/MATLAB/c280x_2833x_adcpwmasynctest_ert_ert_rtw
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
MODELREF_LINK_RSPFILE_NAME = ADC_LED_CAN_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ADC_LED_CAN.out
...
DEFINES_ = -DMODEL=ADC_LED_CAN -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DDAEMON_MODE=1 -DMW_PIL_SCIFIFOLEN=16 -DF2837X_REG_FORMAT -DMW_F2837XD -DRT -DSTACK_SIZE=512
...
DEFINES_SKIPFORSIL = -DDAEMON_MODE=1 -DMW_PIL_SCIFIFOLEN=16 -DF2837X_REG_FORMAT -DMW_F2837XD -DRT -DSTACK_SIZE=512
DEFINES_STANDARD = -DMODEL=ADC_LED_CAN -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
OBJS = MW_c28xx_board.obj ADC_LED_CAN.obj ADC_LED_CAN_data.obj MW_c28xx_adc.obj MW_c28xx_can.obj MW_c28xx_csl.obj can_datatype_ground.obj can.obj interrupt.obj c2837xDBoard_Realtime_Support.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj c2837xDSchedulerTimer0.obj
...
LIBS = C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c28377D.cmd C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/rtlib/IQmath_fpu32.lib C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c2837xDPeripherals.cmd
...
CFLAGS_SKIPFORSIL = -v28 --float_support=fpu32 -ml -DCPU1
...
CPPFLAGS_SKIPFORSIL = -v28 --float_support=fpu32 -ml -DCPU1
...
CPP_LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
%.obj : $(START_DIR)/ADC_LED_CAN_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ADC_LED_CAN_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ADC_LED_CAN_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/ADC_LED_CAN_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
c2837xDBoard_Realtime_Support.obj : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c2837xDBoard_Realtime_Support.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
c2837xDSchedulerTimer0.obj : C:/ProgramData/MATLAB/SupportPackages/R2016b/toolbox/target/supportpackages/tic2000/src/c2837xDSchedulerTimer0.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
